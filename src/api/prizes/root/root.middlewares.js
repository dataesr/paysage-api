...
import {relationshipsRepository,categoriesRepository, weblinksRepository,identifiersRepository,officialtextsRepository, prizesRepository as repository } from '../../commons/repositories';
...
export const storePrice = async (req, res, next) => {
  const {
    identifiers, websites, categories, structures, ...rest
  } = req.body;
