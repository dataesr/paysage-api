import { terms as resource, weblinks as subresource } from '../../resources';
...
describe('API > terms > weblinks > create', () => {
...
describe('API > terms > weblinks > update', () => {
...
describe('API > terms > weblinks > read', () => {
...
describe('API > terms > weblinks > delete', () => {
  it('should throw bad request if id too short', async () => {
    await global.superapp
...
describe('API > terms > weblinks > list', () => {
  beforeAll(async () => {
    await global.superapp
      .post(`/${resource}/${resourceId}/${subresource}`)
      .set('Authorization', authorization)
