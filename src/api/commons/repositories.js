...
export const prizesRepository = new BaseMongoRepository({ db, collection: 'prizes' });
...
export const relationsGroupsRepository = new BaseMongoRepository({ db, collection: 'relationsgroups' });
export const relationTypesRepository = new BaseMongoRepository({ db, collection: 'relationtypes' });
